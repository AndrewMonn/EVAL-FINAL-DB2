...
Tech-Inventory Pro es una aplicación **Full Stack MERN** para la gestión de inventario tecnológico. Permite administrar productos con un CRUD completo, detectar artículos con bajo stock y mantener una base inicial de datos con categorías, proveedores, clientes y ventas.
...
```env
PORT=5000
MONGODB_URI=mongodb+srv://USUARIO:<db_password>@cluster-NOMBRE.mongodb.net/TechinventoryDB?retryWrites=true&w=majority&appName=Cluster-Nombre
```

> Reemplaza `USUARIO` por tu usuario real de MongoDB Atlas.
